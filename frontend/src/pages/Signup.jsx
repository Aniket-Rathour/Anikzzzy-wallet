      ...
      <div className='flex flex-col justify-between  gap-10'>
        ...
        <div className=' flex flex-col bg-white rounded-2xl p-10 shadow-2xl gap-3 w-full max-w-md'>
          ...
          <div className='flex flex-row items-center  border-2 gap-3 border-blue-300 w-90 rounded-2xl p-2 shadow-2xl'>
            ...
            <input type="text" placeholder='First Name' className='w-full px-1 border border-white focus:outline-none focus:rind-0'></input>
          </div>

          <div className='flex flex-row items-center  border-2 gap-3 border-blue-300 w-90 rounded-2xl p-2 shadow-2xl'>
            <img src='/last.png' className='w-6 p'></img>
            <input type="text" placeholder='Last Name' className='w-full px-1 border border-white focus:outline-none focus:rind-0'></input>
          </div>
